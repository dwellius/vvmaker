#!/usr/bin/env python3
"""
Enhanced AI Video Sorter - ИСПРАВЛЕННАЯ ВЕРСИЯ
Более надежная работа без интернета и с любыми видео
"""
...
class SimpleVideoProcessor:
    ...
    def create_single_clip(self, video_path, segment, scene, clip_number, output_dir):
        ...
        # Простая команда FFmpeg без сложных эффектов
        cmd = [
...
def main():
    ...
    print("╔══════════════════════════════════════════════╗")
    print("║     🤖 ENHANCED AI VIDEO SORTER (FIXED)     ║")
